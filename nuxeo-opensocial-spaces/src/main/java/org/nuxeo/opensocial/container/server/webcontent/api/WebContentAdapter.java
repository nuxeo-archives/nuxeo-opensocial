...
/**
 * Adapter around WebContent. WebContent is the base class for all container parts. It exposes some basic properties
 * that can be used by the container It also wraps bidirectionnaly a WebContentData that is a simple Java bean that is
 * usable by the GWT part.
 *
