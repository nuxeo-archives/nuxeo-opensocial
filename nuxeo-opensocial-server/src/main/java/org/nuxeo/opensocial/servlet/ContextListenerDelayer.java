...
/**
 * This class is just a wrapper to hold the initialization of Guice (et al) until we have received the "go ahead" from
 * the Runtime and that everything is fully initialized.
 *
...
public class ContextListenerDelayer implements ServletContextListener {
     ...
     * is fully up and all theuser's configuration files have been loaded into extension points
     */
