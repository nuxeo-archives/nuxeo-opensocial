...
public class TestOpenSocialDescriptor {
    ...
    public void trustedHostShouldBeEqualsToLoopbackIP() {
        Framework.getProperties().put(PARAM_LOOPBACK_URL, "http://127.0.0.1:8080/nuxeo");
        ...
        Framework.getProperties().put(PARAM_LOOPBACK_URL, "http://10.213.2.105:8080/nuxeo");
        trustedHost = openSocialDescriptor.getTrustedHostFromLoopbackURL();
        assertEquals("10.213.2.105", trustedHost);

        Framework.getProperties().put(PARAM_LOOPBACK_URL, "http://[0:0:0:0:0:0:0:1]:8080/nuxeo");
        trustedHost = openSocialDescriptor.getTrustedHostFromLoopbackURL();
        assertEquals("0:0:0:0:0:0:0:1", trustedHost);

        Framework.getProperties().put(PARAM_LOOPBACK_URL, "http://[2a01:240:fe8e:0:226:bbff:fe09:55cd]:8080/nuxeo");
        trustedHost = openSocialDescriptor.getTrustedHostFromLoopbackURL();
