...
public class LayoutModelTest {
    ...
    public void iCanCreateACustomLayout() throws IOException {
        ...
        YUILayout layout = YUILayoutFactory.createLayout(size, true, true, sideBar);
        ...
        YUILayout layout2 = YUILayoutFactory.createLayout(size2, true, true, sideBar);
        // Test de validation de la taille du body
        ...
        assertEquals(((YUIComponentZoneImpl) zone1).getTemplate().getNumberOfComponents(), 1);
        assertEquals((YUIComponent) itr.next(), zone1);
        assertEquals(((YUIComponentZoneImpl) zone2).getCSS(), "yui-gf");
        assertEquals(((YUIComponentZoneImpl) zone2).getTemplate().getNumberOfComponents(), 2);
