...
public interface WebContentSaverService {
    ...
    WebContentData read(DocumentModel doc, CoreSession session) throws Exception;

    WebContentData update(WebContentData data, CoreSession session) throws Exception;
